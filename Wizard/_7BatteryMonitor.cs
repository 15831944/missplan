...
//VOLT_DIVIDER: 12.02
        ...
        public void Activate()
        {
            ...
            try
            {
                ...
                {
                    CustomMessageBox.Show("Kehilangan parameter BATT_CAPACITY, ADA YANG SALAH.", Strings.ERROR);
        ...
        public int WizardValidate()
        {
            ...
            {
                CustomMessageBox.Show("Gagal mengatur ukuran baterai, silahkan cek input anda!");
                return 0;
            }
