...
namespace MissionPlanner.GCSViews
{
    public partial class FlightData : MyUserControl, IActivate, IDeactivate
    {
        ...
        private void BUTactiondo_Click(object sender, EventArgs e)
        {
            ...
            if (
                CustomMessageBox.Show("Apakah anda menentukan akan melakukan " + CMB_action.Text + " ?", "Action",
        ...
        private void gMapControl1_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            else
            {
                ...
                if (Settings.Instance.GetBoolean("CHK_disttohomeflightdata") != false)
                {
                    ...
                    marker.ToolTipText = "Jarak ke Home: " +
...
// square
        ...
        private void BUT_setmode_Click(object sender, EventArgs e)
        {
            ...
            {
                if (CustomMessageBox.Show("You are in failsafe, apakah anda menentukan?", "Failsafe",MessageBoxButtons.YesNo) != (int)DialogResult.Yes)
                {
                    return;
                }
            }
        ...
        private void recordHudToAVIToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            CustomMessageBox.Show("Keluaran avi akan disimpan pada folder log");
        ...
        private void pointCameraHereToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (!MainV2.comPort.BaseStream.IsOpen)
            {
                CustomMessageBox.Show("Sambungkan dahulu");
                return;
            }
        ...
        private void BUT_ARM_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (MainV2.comPort.MAV.cs.armed)
                    if (CustomMessageBox.Show("Apakah anda ingin untuk Disarm?", "Disarm?", MessageBoxButtons.YesNo) !=
        ...
        internal void BUT_run_script_Click(object sender, EventArgs e)
        {
            if (File.Exists(selectedscript))
            {
                ...
                labelScriptStatus.Text = "Script Status: Berjalan";
            ...
            {
                CustomMessageBox.Show("Silahkan memilih script yang valid", "Bad Script");
            }
        }
        ...
        private void scriptChecker_Tick(object sender, EventArgs e)
        {
            if (!scriptrunning)
            {
                labelScriptStatus.Text = "Script Status: Selesai (atau digugurkan)";
            ...
            using (OpenFileDialog openFileDialog1 = new OpenFileDialog())
            {
                ...
                if (openFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    foreach (string logfile in openFileDialog1.FileNames)
                    {
                        ...
                        {
                            CustomMessageBox.Show("Gagal memproses file. Pastikan file tidak terpakai/dijalankan.\n" + ex);
                        }
        ...
        private void BUT_resumemis_Click(object sender, EventArgs e)
        {
            if (
                Common.MessageShowAgain("Resume Mission",
                    "Peringatan ini akan memrogram kembali misi anda, arm and issue perintah takeoff (copter)") !=
                DialogResult.OK)
                return;
            ...
            try
            {
                if (MainV2.comPort.BaseStream.IsOpen)
                {
                    ...
                    if (InputBox.Show("Resume at", "Lanjutkan misi pada waypoint#", ref lastwp) == DialogResult.OK)
                    {
                        int timeout = 0;
