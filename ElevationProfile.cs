...
namespace MissionPlanner
{
    public partial class ElevationProfile : Form
    {
        ...
        public ElevationProfile(List<PointLatLngAlt> locs, double homealt, GCSViews.FlightPlanner.altmode altmode)
        {
            ...
            if (planlocs.Count <= 1)
            {
                CustomMessageBox.Show("Silahkan membuat rencana dahulu", Strings.ERROR);
                return;
            }
        ...
        public void CreateChart(ZedGraphControl zgc)
        {
            ...
            myPane.XAxis.Title.Text = "Jarak (m)";
            myPane.YAxis.Title.Text = "Elevation (m)";

            LineItem myCurve;

            myCurve = myPane.AddCurve("Rencana jalur", list1, Color.Red, SymbolType.None);
