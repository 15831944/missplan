#pragma checksum "D:\missplan\MissionPlanner\ExtLibs\wasm\Pages\tlog.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f10a83da7b607928214d9ffd8bafd87cbdd8eeae"
// <auto-generated/>
...
namespace wasm.Pages
{
    ...
    [Microsoft.AspNetCore.Blazor.Components.RouteAttribute("/tlog")]
    public class tlog : Microsoft.AspNetCore.Blazor.Components.BlazorComponent, IDisposable
    {
...
#line 40 "D:\missplan\MissionPlanner\ExtLibs\wasm\Pages\tlog.cshtml"
    ...
    {
        var stream = await Http.GetStreamAsync("2018-09-09 18-15-17.txt");

        await ProcessTlogStream(stream);
    }
        ...
        foreach (var file in await fileReaderService.CreateReference(inputTypeFileElement).EnumerateFilesAsync())
        {
            ...
            if (info.Name.ToLower().EndsWith("tlog"))
            {
                ...
                using (MemoryStream memoryStream = await file.CreateMemoryStreamAsync(4096))
                {
                    ...
                    await ProcessTlogStream(memoryStream);
                }
            }
            else
            {
