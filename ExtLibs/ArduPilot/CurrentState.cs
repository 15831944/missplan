...
namespace MissionPlanner
{
	...
	float _crit_aoa = 25;
        ...
        [DisplayText("Waktu di udara (sec)")]
        ...
        [DisplayText("Waktu di udara (min.sec)")]
        ...
        [DisplayText("Arah angin (Deg)")]
        public float wind_dir { get; set; }

        [DisplayText("Kecepatan angin (speed)")]
        ...
        [DisplayText("jarak menuju Base (dist)")]
