...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        public MainV2()
        {
            ...
            catch (ArgumentException e)
            {
                ...
                CustomMessageBox.Show(e.ToString() +
                                      "\n\n Font Bermasalah? Silahkan Install dari http://www.microsoft.com/en-us/download/details.aspx?id=16083");
                //splash.Close();
                //this.Close();
                Application.Exit();
            }
            ...
            {
                log.Fatal(e);
                CustomMessageBox.Show("Kesalahan major terjadi pada : " + e.ToString());
                Application.Exit();
            }
            ...
            if (!MONO)
            {
                ...
                if (Framework < 4.0)
                {
                    CustomMessageBox.Show("Program ini membutuhkan .NET Framework 4.0. Versi milik anda saat ini adalah " + Framework);
                }
            }
        ...
        {
            log.Info("Reset kondisi koneksi");
        ...
        public void doConnect(MAVLinkInterface comPort, string portname, string baud, bool getparams = true)
        {
            ...
            log.Info("Kita tersambung ke " + portname + " " + baud );
            switch (portname)
            {
                case "preset":
            ...
            catch (Exception ex)
            {
                ...
                CustomMessageBox.Show("Tidak dapat membuat koneksi\n\n" + ex.Message);
                return;
            }
        }
                                ...
                                catch
                                {
                                    ...
                                    this.BeginInvoke(
                                        (Action)
                                            delegate
                                            {
                                                CustomMessageBox.Show("Gagal memperbarui lokasi Home (" +
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                if (CustomMessageBox.Show("Anda masih pertama kali menjalankan ini, Apakah anda ingin setup wizard?\nDirekomendasikan untuk pengguna baru.", "Wizard", MessageBoxButtons.YesNo) == (int)System.Windows.Forms.DialogResult.Yes)
                {
                ...
                CustomMessageBox.Show("Untuk memakai fitur Wizard, Silahkan menuju layar initial setup, lalu klik ikon wizard.", "Wizard");
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            if (keyData == (Keys.Control | Keys.Y)) // for ryan beall and ollyw42
            {
                ...
                {
                    CustomMessageBox.Show("Perintah Salah");
                    return true;
                }
                //read
        ...
        private void toolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            {
                CustomMessageBox.Show("Link gagal dibuka. check your default webpage association");
            }
        }
        ...
        {
            // Advanced view
            if (advancedViewToolStripMenuItem.Checked)
            {
        ...
        private void MenuArduPilot_Click(object sender, EventArgs e)
        {
            ...
            {
                CustomMessageBox.Show("Gagal membuka url http://ardupilot.org");
            }
        }
