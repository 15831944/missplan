...
namespace MissionPlanner.Swarm.WaypointLeader
{
    public partial class WPControl : Form
    {
        ...
        public WPControl()
        {
            ...
            zedGraphControl1.GraphPane.XAxis.Title.Text = "jarak";
        ...
        private void but_start_Click(object sender, EventArgs e)
        {
            ...
            foreach (var port in MainV2.Comports)
            {
                foreach (var MAV in port.MAVlist)
                {
                    ...
                    {
                        var result = CustomMessageBox.Show("There appears to be a drone in the air at the moment. Apakah anda ingin melanjutkan?", "continue", MessageBoxButtons.YesNo);
